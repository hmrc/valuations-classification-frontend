...
object Attachment {
  implicit val fmt: OFormat[Attachment] = Json.format[Attachment]
}
...
object AgentDetails{
  implicit val fmt = Json.format[AgentDetails]
}
...
object ValuationApplication{
  implicit val fmt: OFormat[ValuationApplication] = Json.format[ValuationApplication]
}
