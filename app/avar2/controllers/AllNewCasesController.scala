...
class AllNewCasesController @Inject()(
  ...
  def displayAllNewCases(activeSubNav: avar2.models.viewmodels.AvarSubNavigationTab = avar2.models.viewmodels.AVaRTab): Action[AnyContent] =
