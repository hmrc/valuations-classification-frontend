...
class IndexController @Inject()(
                                 authenticate: AuthenticatedCaseWorkerAction,
  ...
  def get(): Action[AnyContent] = authenticate { implicit request: AuthenticatedCaseWorkerRequest[AnyContent] =>
    request.caseWorker.role match {
