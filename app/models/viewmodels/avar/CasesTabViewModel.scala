...
import avar2.models.{Paged, ValuationCase}


case class CasesTab(tabMessageKey: String, elementId: String, searchResult: Paged[ValuationCase])

case class CasesTabViewModel(headingMessageKey: String, casesTabs: List[CasesTab])
...
//  }
  ...
  def create(cases: Paged[ValuationCase]): CasesTabViewModel = {
    ...
    CasesTabViewModel(s"cases.opencases.avar.heading", List(tab))
  }
}
