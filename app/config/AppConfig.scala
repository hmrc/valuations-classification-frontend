...
class AppConfig @Inject() (
  ...
  lazy val bindingvaluationsClassificationUrl: String = servicesConfig.baseUrl("binding-valuations-classification")
  lazy val rulingUrl: String                          = servicesConfig.baseUrl("binding-valuations-ruling-frontend")
  ...
  lazy val fileStoreUrl: String                       = servicesConfig.baseUrl("binding-valuations-filestore")
