...
import connector.BindingvaluationsClassificationConnector
import models.Case
...
trait ConnectorCaptor {
  ...
  protected def theEventCreatedFor(connector: BindingvaluationsClassificationConnector, c: Case): NewEventRequest = {
  ...
  protected def theCaseUpdating(connector: BindingvaluationsClassificationConnector): Case = {
