...
class BindingvaluationsClassificationConnectorSpec extends ConnectorTest with CaseQueueBuilder {

  import utils.JsonFormatters._

  private val pagination = SearchPagination(1, 2)

  private val connector = new BindingvaluationsClassificationConnector(mockAppConfig, authenticatedHttpClient, metrics)
