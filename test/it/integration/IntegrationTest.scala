...
trait IntegrationTest
  ...
  override def fakeApplication(): Application =
    new GuiceApplicationBuilder()
      ...
      .configure(
        Map(
          "microservice.services.binding-valuations-classification.port" -> wirePort,
          "microservice.services.binding-valuations-filestore.port"      -> wirePort,
...
//          "platform-url.host" -> s"http://localhost:$port",
  ...
  protected val baseUrl = s"http://localhost:$port/manage-valuations-classifications"
